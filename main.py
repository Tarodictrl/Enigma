...
parser.add_argument('-r', '--rotor',
                    ...
                    action='append', choices=rotorb_instance.values, metavar='', default=["ROTOR_I", "ROTOR_II", "ROTOR_III"])
parser.add_argument('-k', '--key', help="For example --key a --key b --key c. Default a, a, a", action='append', default=["a", "a", "a"])
